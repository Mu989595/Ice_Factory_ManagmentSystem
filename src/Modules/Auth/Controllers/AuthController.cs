...
public class AuthController : ControllerBase
{
    ...
    [HttpPost("register")]
    [ProduceResponseType(typeof(ApiResponse<AuthResponseDto>), StatusCodes.Status200OK)]
    ...
    [HttpPost("login")]
    [ProduceResponseType(typeof(ApiResponse<AuthResponseDto>), StatusCodes.Status200OK)]
    [ProduceResponseType(typeof(ApiResponse<object>), StatusCodes.Status401Unauthorized)]
